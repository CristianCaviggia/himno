...
public class DepositoTest {
    ...
    public void testAgregar() {
        ...
        for (int i = 0; i < cantidadDeposito; i++) {
            assertTrue("Fallo al agregar deposito al paquete", deposito.agregar(paquetes[i]));
        ...
        for (int i = cantidadDeposito; i < cantidadPaquetes; i++) {
            assertFalse("Fallo si no contiene el paquete despues de agregarlo", deposito.agregar(paquetes[i]));
        }
