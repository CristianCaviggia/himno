...
public class FrameAhorcado extends JFrame implements ActionListener {
    ...
    public JPanel Teclado() {
        ...
        contenedorTeclado.setBorder(new PanelBorder(Color.BLACK, 2, TitledBorder.CENTER, ""));
        String[] letras = {"A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L", "M", "N", "Ñ", "O", "P", "Q", "R", "S", "T", "U", "V",
            "W", "X", "Y", "Z", "Nuevo", "Solucion", "Salir"};
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if ((evento == "INICAR AHORCADO") && (bloquea != true)) {
            Panel();
        }
        if (evento == "OPCIONES") {
